...
![ProbConv-fagb](/images/understand-convolution/ProbConv-fagb.png)
...
![ProbConv-split-21](/images/understand-convolution/ProbConv-split-21.png)
...
![ProbConv-splits-12-03](/images/understand-convolution/ProbConv-splits-12-03.png)
...
![ProbConv-OnePath](/images/understand-convolution/ProbConv-OnePath.png)

To get the convolution, we consider all intermediate positions.

![ProbConv-SumPaths](/images/understand-convolution/ProbConv-SumPaths.png)
...
![ProbConv-Reverse](/images/understand-convolution/ProbConv-Reverse.png)

If we know the ball lands at a position c after the second drop, what is the probability that the previous position was $a$?

![ProbConv-BackProb](/images/understand-convolution/ProbConv-BackProb.png)
...
![ProbConv-Intermediate](/images/understand-convolution/ProbConv-Intermediate.png)
...
![ProbConv-Intermediate-Align](/images/understand-convolution/ProbConv-Intermediate-Align.png)

And shrinks as the intersection between the distributions gets smaller.

![ProbConv-Intermediate-Sep](/images/understand-convolution/ProbConv-Intermediate-Sep.png)
...
![Wiki-BoxConvAnim](/images/understand-convolution/Wiki-BoxConvAnim.gif)
...
![ProbConv-TwoDim](/images/understand-convolution/ProbConv-TwoDim.png)
...
![RiverTrain-ImageConvDiagram](/images/understand-convolution/RiverTrain-ImageConvDiagram.png)
...
![Gimp-Blur](/images/understand-convolution/Gimp-Blur.png)
...
![Gimp-Edge](/images/understand-convolution/Gimp-Edge.png)
...
![Conv-9-Conv2-XY](/images/understand-convolution/Conv-9-Conv2-XY.png)
...
![Conv-9-Conv2-XY-W](/images/understand-convolution/Conv-9-Conv2-XY-W.png)
...
![Conv2-5x5-Conv2-XY](/images/understand-convolution/Conv2-5x5-Conv2-XY.png)
