...
![](/images/self-supervised-representation-learning/self-sup-lecun.png)
...
![examplar-cnn](/images/self-supervised-representation-learning/examplar-cnn.png)
...
![self-sup-rotation](/images/self-supervised-representation-learning/self-sup-rotation.png)
...
![self-sup-by-relative-position](/images/self-supervised-representation-learning/self-sup-by-relative-position.png)
...
![chromatic-aberration](/images/self-supervised-representation-learning/chromatic-aberration.png)
...
![self-sup-jigsaw-puzzle](/images/self-supervised-representation-learning/self-sup-jigsaw-puzzle.png)
...
![](/images/self-supervised-representation-learning/self-sup-counting-features.png)
...
![](/images/self-supervised-representation-learning/context-encoder.png)
...
![](/images/self-supervised-representation-learning/split-brain-autoencoder.png)
...
![](/images/self-supervised-representation-learning/bi-GAN.png)
...
![](/images/self-supervised-representation-learning/CPC-audio.png)
...
![](/images/self-supervised-representation-learning/CPC-image.png)
...
![](/images/self-supervised-representation-learning/tracking-videos.png)
...
![](/images/self-supervised-representation-learning/frame-order-validation.png)
...
![](/images/self-supervised-representation-learning/learning-arrow-of-time.png)
...
![](/images/self-supervised-representation-learning/video-colorization.png)
...
![](/images/self-supervised-representation-learning/video-colorization-examples.png)
...
![](/images/self-supervised-representation-learning/grasp2vec.png)
...
![](/images/self-supervised-representation-learning/grasp2vec-attention-map.png)
...
![](/images/self-supervised-representation-learning/TCN.png)
...
![](/images/self-supervised-representation-learning/mfTCN.png)
...
![](/images/self-supervised-representation-learning/RIG.png)
...
![](/images/self-supervised-representation-learning/RIG-algorithm.png)
...
![](/images/self-supervised-representation-learning/CC-RIG.png)
...
![](/images/self-supervised-representation-learning/CC-RIG-goal-samples.png)
...
![](/images/self-supervised-representation-learning/DeepMDP.png)
...
![](/images/self-supervised-representation-learning/DBC-illustration.png)
...
![](/images/self-supervised-representation-learning/DBC-algorithm.png)
