...
![sface3](/images/understanding-matrix-capsules-with-EM-routing/sface3.jpg)
...
![cnn1](/images/understanding-matrix-capsules-with-EM-routing/cnn1.jpg)
...
![face2](/images/understanding-matrix-capsules-with-EM-routing/face2.jpg)
...
![a2](/images/understanding-matrix-capsules-with-EM-routing/a2.png)
...
![c21](/images/understanding-matrix-capsules-with-EM-routing/c21.jpg)

For example, the same network layer can detect a face rotated clockwise.

![c22](/images/understanding-matrix-capsules-with-EM-routing/c22.jpg)
...
![capp](/images/understanding-matrix-capsules-with-EM-routing/capp.png)
...
![data](/images/understanding-matrix-capsules-with-EM-routing/data.png)
...
![GM2](/images/understanding-matrix-capsules-with-EM-routing/GM2.png)
...
![cluster](/images/understanding-matrix-capsules-with-EM-routing/cluster.jpg)
...
![c3](/images/understanding-matrix-capsules-with-EM-routing/c3.jpg)
...
![em](/images/understanding-matrix-capsules-with-EM-routing/em.gif)
...
![GM1](/images/understanding-matrix-capsules-with-EM-routing/GM1.png)
...
![gh](/images/understanding-matrix-capsules-with-EM-routing/gh.png)
...
![cluster2](/images/understanding-matrix-capsules-with-EM-routing/cluster2.jpg)
...
![c2](/images/understanding-matrix-capsules-with-EM-routing/c2.jpg)
...
$$ r*{ij} $$ , $$ \mu $$ , $$ \sigma $$ and $$ a_j $$ are computed iteratively using EM routing discussed in the next section. λ in the equation above is the inverse temperature parameter $$ \frac{1}{temperature} $$ . As $$ r*{ij} $$ is getting better, we drop the temperature (larger λ) which increase the steepness in the s-curve in $$ sigmoid(z) $$ . It helps us to fine tune $$ r_{ij} $$ better with higher sensitivity to vote discrepancy in these region. In our implementation, λ is first initialized to 1 at the beginning of the iterations and then increment by 1 after each routing iteration. The paper does not specific the details and we would suggest experimenting different schemes in your implementation.
...
![al3](/images/understanding-matrix-capsules-with-EM-routing/al3.png)
...
![data2](/images/understanding-matrix-capsules-with-EM-routing/data.png)
...
![cape](/images/understanding-matrix-capsules-with-EM-routing/cape.png)
(Picture from the Matrix capsules with EM routing paper).
...
![iter](/images/understanding-matrix-capsules-with-EM-routing/iter.png)

The error rate for the Capsule network is generally lower than a CNN model with similar number of layers as shown below.

![resu](/images/understanding-matrix-capsules-with-EM-routing/resu.png)
...
![m2](/images/understanding-matrix-capsules-with-EM-routing/m2.png)
(Source from the Matrix capsules with EM routing paper)
